...
declare namespace React {
  ...
  type BaseSyntheticEvent<E = object, C = any, T = any> = any;
  ...
  interface ClipboardEvent<T = Element> extends Record<string, any> {}

  interface CompositionEvent<T = Element> extends Record<string, any> {}

  interface DragEvent<T = Element> extends Record<string, any> {}

  interface PointerEvent<T = Element> extends Record<string, any> {}

  interface FocusEvent<Target = Element, RelatedTarget = Element>
    extends Record<string, any> {}

  interface FormEvent<T = Element> extends Record<string, any> {}

  interface InvalidEvent<T = Element> extends Record<string, any> {}

  interface ChangeEvent<T = Element> extends Record<string, any> {}
  ...
  interface KeyboardEvent<T = Element> extends Record<string, any> {}

  interface MouseEvent<T = Element, E = NativeMouseEvent>
    extends Record<string, any> {}

  interface TouchEvent<T = Element> extends Record<string, any> {}

  interface UIEvent<T = Element, E = NativeUIEvent>
    extends Record<string, any> {}

  interface WheelEvent<T = Element> extends Record<string, any> {}

  interface AnimationEvent<T = Element> extends Record<string, any> {}

  interface TransitionEvent<T = Element> extends Record<string, any> {}

  //
  // Event Handler Types
  // ----------------------------------------------------------------------

  type EventHandler<E extends Record<string, any>> = any;

  type ReactEventHandler<T = Element> = any;
