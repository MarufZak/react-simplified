...
export const TextInput = ({
  ...
  return (
    <div className={cn("flex flex-col", className)}>
      ...
      <input
        className="border border-neutral-200 rounded-[4px] bg-neutral-0 text-sm placeholder:text-neutral-600 text-neutral-800 h-10 focus-visible:border-2 focus-visible:border-primary-600 outline-none px-4 disabled:bg-neutral-150 disabled:text-neutral-600"
        id={id}
        {...props}
      />
      {description && (
    ...
    <div className={cn("flex flex-col", className)}>
      ...
      <div className="relative">
        <input
          ...
          className="w-full border border-neutral-200 rounded-[4px] bg-neutral-0 text-sm placeholder:text-neutral-600 text-neutral-800 h-10 focus-visible:border-2 focus-visible:border-primary-600 outline-none px-4 disabled:bg-neutral-150 disabled:text-neutral-600"
          id={id}
          disabled={disabled}
          {...props}
        />
